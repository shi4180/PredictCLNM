...
params = {'n_estimators': 2000, 'max_depth': 4, 'max_leaf_nodes': 3 }
...
df2.to_csv("D:\\enen\\data\\ASUSdoucment\\python porject\\shaplast\\predtrainRF10.csv", header=True, index=None)
