...
import shap
import sklearn
df = pd.read_csv('D:\\ASUSdoucment\\python porject\\shaplast\\Newdatathreetiao2.csv')
y = df['CLNM']
...
shap.plots.partial_dependence(
    "Calcification", model.predict, X, ice=True,
    model_expected_value=True, feature_expected_value=True
)
shap.force_plot(explainer.expected_value, shap_values[787, :], Xcat.iloc[787, :], link="identity", matplotlib=True)
shap.force_plot(explainer.expected_value, shap_values[787], Xcat.iloc[787], link="logit", matplotlib=True)
