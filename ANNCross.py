...
params = {'alpha': 0.00001, 'learning_rate_init': 0.01, 'power_t':0.01, 'max_iter': 110, 'tol':0.001,
...
pretrain.to_csv("D:\\enen\\data\\ASUSdoucment\\python porject\\shaplast\\predtrainANN10.csv", header=True, index=None)
