...
df5 = pd.DataFrame(y_dzong)
pretest = pd.DataFrame(y_pred)
predtrain = pd.DataFrame(y_predtrain)
predval2 = pd.DataFrame(y_pred2)


df2.to_csv("D:\\enen\\data\\ASUSdoucment\\python porject\\shaplast\\predtrainxgb.csv", header=True, index=None)